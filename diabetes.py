...
@app.route('/recommend_heart_drugs.html')
def recommend():
    return render_template('recommend_heart_drugs.html', data = None)


@app.route('/book_appointment.html')
def appoint():
    return render_template('book_appointment.html', data = None)

@app.route('/recommend_diabetes_drugs.html')
def recommend_diabetes():
    return render_template('recommend_diabetes_drugs.html', data = None)
...
def result():
    ...
    if request.method == 'POST':
        ...
        return render_template('homepage.html',data = prediction[0])
...
def result_heart():
    ...
    if request.method == 'POST':
        ...
        # prediction2 = str(prediction2[0])
        print(f"Data to be sent: {prediction2}")
       
        return render_template('h_disease.html',data = prediction2[0])
    return render_template('h_disease.html', data = None)
